...
<body>
    ...
    <section class="main overlay-black">
        ...
        <div class="container wrapper">
            ...
            <!-- Start of Form -->
            <form class="job-search-form row pt40" action="results3" method="post">
                ...
                <label for="search-categories">Category</label>
                    <select name="jobs" class="selectpicker" id="search-categories" data-live-search="true" title="Any Category" data-size="5" data-container="body">
                        @foreach ($jobs as $job)
