...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top fluid_header centered">
            <div class="container">
                ...
                <div class="col-md-2 col-sm-6 col-xs-8 nopadding">
                    <a class="navbar-brand nomargin" href="/"><img src="images/logo.svg" alt="logo"></a>
    ...
    <section class="main overlay-black">
        ...
        <div class="container wrapper">
            ...
            <!-- Start of Form -->
            <form class="job-search-form row pt40" action="results4" method="post">
                ...
                <label for="search-categories">Category</label>
                    <select name="interests" class="selectpicker" id="search-categories" data-live-search="true" title="Any Category" data-size="5" data-container="body">
