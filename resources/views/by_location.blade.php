...
<body>
    ...
    <section class="main overlay-black">
        ...
        <div class="container wrapper">
            ...
            <!-- Start of Form -->
            <form class="job-search-form row pt40" action="results2" method="post">
                ...
                <label for="search-categories">Category</label>
                    <select name="locations" class="selectpicker" id="search-categories" data-live-search="true" title="Any Category" data-size="5" data-container="body">
